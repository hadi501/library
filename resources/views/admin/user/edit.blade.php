...
<div class="container">
    <div class="row">
        <div class="col text-center">
            <h3 class="mt-3 mb-4 p-2" style="background-color: #343a40;color: #fafafa;border-radius: 10px;box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.1);">Edit User</h3>
        </div>
    </div>
    <div class="row">
        ...
        <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="password" class="form-control custom-form-control" name="password" id="password" value="notdisplay" readonly>
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <select name="role" id="role" class="form-select custom-form-control" required>
                        ...
                        <option value="2" @if($user->role == "2") selected @endif>Bendahara</option>
                        <option value="3" @if($user->role == "3") selected @endif>Super Admin</option>
                    </select>
                </div>

			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						...
						<form action="/token" method="POST" class="signin-form">
						@csrf
			      		<div class="form-group mb-3">
			      			<label class="label" for="name">Token</label>
			      			<input name="token_validate" id="token_validate" type="number" class="form-control @error('token') is-invalid @enderror" placeholder="masukan token..." autofocus required>
							@error('token')

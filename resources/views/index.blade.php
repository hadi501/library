...
<div class="col-12 col-md-5 d-block border-bottom border-3">
  <!-- <book-card bookid="664" bookname="Ulumul hadits" bookyear="2002" bookcategory="Hadits" bookauthor="Sohari Sahrani" bookpublisher="Ghalia Indonesia" bookstatus="0" bookdetailurl="/book/B0074" bookfavoriteurl="..." bookfavorite="false" bookcover="{{ asset('images/book/kitab.jpg') }}"> -->
  <div>
    <div class="row mb-2">
      <div class="col col-md-5 text-center ">
        <div class="position-relative">
      ...
      <div class="col col-md-7 pt-2 d-flex flex-column col-book">
        <div class="col">
          <a class="book-field text-dark" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" data-bs-source="bookDetail">
            <h4 class="book-title"><!--?lit$116348074$-->Ulumul hadits</h4>
          </a>

          <h5 class="book-author"><!--?lit$116348074$-->Sohari Sahrani</h5>
          <p class="book-year"><!--?lit$116348074$-->2002</p>
        </div>
        <div class="col d-flex align-items-end">
          <div>
            <p class="fw-bold mb-0">Kategori</p>
